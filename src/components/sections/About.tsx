...
export function About() {
  return (
    <section id="about" className="relative pt-2 pb-16 sm:pt-4 sm:pb-24 scroll-mt-24">
      <div className="mx-auto w-[min(1200px,92%)]">
        <SectionHeader eyebrow="About" title="Data-Driven Engineering." />

        <div className="mt-12 grid lg:grid-cols-[1fr_1.2fr] gap-12 items-start">
          <motion.div
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <h3 className="font-display text-xl font-semibold mb-3">Education & Certificates</h3>
              <div className="space-y-4 text-sm">
                <div>
                  <p className="font-medium text-foreground">BSc (Hons) Mechanical Engineering in production</p>
                  <div className="flex justify-between items-center gap-2 mt-0.5">
                    <p className="text-muted-foreground">University of Rwanda</p>
                    <span className="text-accent/80 text-xs whitespace-nowrap">May 2022 — July 2026</span>
                  </div>
                </div>
              ...
              <div className="space-y-5 text-sm">
                <div>
                  ...
                  <div className="flex justify-between items-center gap-2 mt-0.5">
                    ...
                    <span className="text-accent/80 text-xs whitespace-nowrap">Jan 2026 — Present</span>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex justify-between items-center gap-2 mt-0.5">
                    <p className="text-muted-foreground">University of Rwanda | Data Science Club</p>
